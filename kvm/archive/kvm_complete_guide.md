...
sudo pacman -S qemu-full qemu-img guestfs-tools libvirt virt-manager virt-install virt-viewer bridge-utils cloud-utils (cloud-image-utils on Debian/Ubuntu) edk2-ovmf libosinfo tuned
